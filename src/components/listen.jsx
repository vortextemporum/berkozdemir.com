    ...
    render() {
        return (
            <div className="flex flex-column">
                ...
                <div className="w80 pa3 center"><img src={pcbanner} alt="Princess Camel banner"></img></div>
                ...
                <div id="listencontainer" className="bg-black-70 shadow-4-l b--dashed b--orange w-80 center flex justify-around flex-wrap items-center mt3"> 
                    ...
                    <iframe title="Album of Things #01" className="ma3" style={{border: 0, width: 400 + 'px', height: 300 + 'px'}} src="https://bandcamp.com/EmbeddedPlayer/album=3125905424/size=large/bgcol=333333/linkcol=2ebd35/artwork=small/transparent=true/" seamless><a href="http://berkozdemir.bandcamp.com/album/album-of-things-01">Album of Things #01 by Princess Camel</a></iframe>
                    <iframe title="Vedat Chili Peppers album" className="ma3" style={{border: 0, width: 400 + 'px', height: 300 + 'px'}} src="https://bandcamp.com/EmbeddedPlayer/album=2231919942/size=large/bgcol=333333/linkcol=2ebd35/artwork=small/transparent=true/" seamless><a href="http://berkozdemir.bandcamp.com/album/vedat-chili-peppers">Vedat Chili Peppers by Berk Özdemir</a></iframe>
                    <iframe title="tape/md2eu album" className="ma3" style={{border: 0, width: 400 + 'px', height: 300 + 'px'}} src="https://bandcamp.com/EmbeddedPlayer/album=4196865636/size=large/bgcol=333333/linkcol=2ebd35/artwork=small/transparent=true/" seamless><a href="http://berkozdemir.bandcamp.com/album/tape-md2eu">tape/md2eu by Berk Özdemir</a></iframe>
                    <iframe title="Spotify playlist" className="ma3" src="https://open.spotify.com/embed/user/1124037609/playlist/7Hob3hcgkAM8V3XOObxNtY" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                    ...
                    <iframe title="SoundCloud Berk" className="ma3" width="50%" height="450" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/users/5701888&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe>
                    <iframe title="YouTube playlist Princess Camel" className="ma3" width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLL-JW4H9We1yFMa0IvJqjESOu6ctFvCFB" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
