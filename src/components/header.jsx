...
class Header extends Component {
    render() {
        ...
        <header className="bg-black-80 flex flex-wrap justify-around ph2 pv2 pv3-ns ph4-m ">
            ...
            <nav  className="pressstart2p center tc f6 fw6 ttu tracked">
            {/* <nav  className="nunito center tc f4 fw6 ttu tracked"> */}
                ...
                {/* <Link id="headerlink" className="link dim light-purple dib pa3"  to="/cryptothings" title="cryptothings">crypto/P2P/blockchain</Link> */}
                {/* <Link id="headerlink" className="link dim green dib pa3"  to="/cryptothings" title="rareberk">RAREBERK VR GALLERY</Link> */}
