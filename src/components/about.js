    ...
    render() {
        return(
            ...
            >
                        ...
                        <p>In university,  I studied composition in Mimar Sinan University of Fine Arts, State Conservatory and got my bachelor degree in 2017. Unfortunately, I couldn't be very creative in that period, because I had lost my motivation to compose due to the lack of the opportunities the school provided and some other reasons. I only composed around 10 pieces for different combinations of acoustical instruments (solo instruments, ensembles, orchestra), and only 3 of them were performed.</p>
                        
                        <p>Also in 2011, I founded a Youtube channel about gaming and vlog called "Videoyun" with my childhood buddy Batu Bozkan, and actively created content for it regularly for years, and did livestreams on Twitch. At that time, it became one of the biggest Youtube and Twitch channels in Turkey. Right now the Youtube channel still stays, but not active that much since 2015; but in the Twitch channel Batu still streams almost everyday, and I'm also taking baby steps to start again doing livestreams. I had also created a personal Youtube channel under my name in 2017, but failed to manage it (hope to solve that in the future!), and I'm rarely uploading content there.</p>
